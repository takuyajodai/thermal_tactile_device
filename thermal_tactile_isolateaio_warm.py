...
def main():
    ...
    temp_list = [-2000,-1500,-1000,-500, 0, 500, 1000, 1500, 2000]
    ...
    # ファイル出力
    f = open('./exp_warm/' + subject_name + '_result.csv', 'w', newline='') 
    ...
    f = open('./exp_warm/' + subject_name + '_answer.csv', 'w', newline='') 
